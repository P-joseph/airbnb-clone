...
def github_login(request):
    ...
    redirect_uri = "http://airbnb-clone.eba-2kj8pb3x.ap-northeast-2.elasticbeanstalk.com/users/login/github/callback"
...
def kakao_login(request):
    ...
    redirect_uri = "http://airbnb-clone.eba-2kj8pb3x.ap-northeast-2.elasticbeanstalk.com/users/login/kakao/callback"
